...
annot_folder = '/Users/arif/Google Drive/My Drive/40 Books Papers/Kobo Annotations' # replace with annotation local folder
# Define result folder root
folder_name = '/Users/arif/second-brain/everfoam/docs/book-annotations' # replace with target folder
